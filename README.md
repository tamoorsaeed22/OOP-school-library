...
In this project, I will start building school library app. In this initial step, I will implement the classes to represent students and teachers.
...
```sh
  ...
  git clone git@github.com:tamoorsaeed22/OOP-school-library.git
```
